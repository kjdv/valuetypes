...
bool operator==(const TemplateParameter& a, const TemplateParameter& b) noexcept {
    return std::tie(a.type, a.optional, a.name) ==
...
bool operator==(const Member& a, const Member& b) noexcept {
    return std::tie(a.name, a.type, a.default_value, a.optional, a.value_type, a.value_types) ==
...
bool operator==(const Definition& a, const Definition& b) noexcept {
    return std::tie(a.name, a.members) ==
...
kjson::document to_kjson(const TemplateParameter& v) {
    return composite::make_mapping(
        "type", to_kjson(v.type), "optional", to_kjson(v.optional), "name", to_kjson(v.name));
}
...
kjson::document to_kjson(const Member& v) {
    return composite::make_mapping(
        "name", to_kjson(v.name), "type", to_kjson(v.type), "default_value", to_kjson(v.default_value), "optional", to_kjson(v.optional), "value_type", to_kjson(v.value_type), "value_types", to_kjson(v.value_types));
}
...
kjson::document to_kjson(const Definition& v) {
    return composite::make_mapping(
        "name", to_kjson(v.name), "members", to_kjson(v.members));
}
...
kjson::document to_kjson(const DefinitionStore& v) {
    return composite::make_mapping(
        "ns", to_kjson(v.ns), "types", to_kjson(v.types));
}
